...
void CreateDefaultINI()
{
    ...
    const char* szDefaultINI = 
        ...
        "Name=WSL Bash\r\n"
        "Name.cs=WSL Bash\r\n"
        "Command=wsl.exe bash -i\r\n"
        "Description=WSL Bash shell (use -i flag for interactive mode with prompts)\r\n"
        "Description.cs=WSL Bash shell (použijte -i pro interaktivní režim s výzvami)\r\n"
        "Category=Interactive\r\n"
        "Category.cs=Interaktivní\r\n"
        "Action=repl\r\n"
        "PromptEnd=$ \r\n"
