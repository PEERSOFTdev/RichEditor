...
void CreateDefaultINI()
{
    ...
    const char* szDefaultINI = 
        ...
        "Name=WSL Bash\r\n"
        "Name.cs=WSL Bash\r\n"
        "Command=wsl.exe script -qfc \"stty -echo; exec bash\" /dev/null\r\n"
        "Description=WSL Bash shell (script for PTY, stty -echo disables input echo)\r\n"
        "Description.cs=WSL Bash shell (script pro PTY, stty -echo vypne echo vstupu)\r\n"
        "Category=Interactive\r\n"
        "Category.cs=Interaktivní\r\n"
        "Action=repl\r\n"
        "PromptEnd=$ \r\n"
